...
json_t * vGenMCUINFOMsg(VPD vpd)
{
	...
	//connectednuinfo
	res = json_object_set(mcuinfo,"connectednuinfo",
		json_pack("[{s:b,s:s},{s:b,s:s}]",
			"connectedstate",1,
			"connectedip",_gstrpShm->rc.nSrvIP,
			"connectedstate",1,
	...
	//connectedmpinfo
	res = json_object_set(mcuinfo,"connectedmpinfo",
		json_pack("[{s:b,s:s},{s:b,s:s}]",
			"connectedstate",1,
			"connectedip",_gstrpShm->rc.nSrvIP,
			"connectedstate",1,
	...
	res = json_object_set(mcuinfo,"connectedmpcadaptinfo",
		json_pack("[{s:b,s:s},{s:b,s:s}]",
			"connectedstate",1,
			"connectedip",_gstrpShm->rc.nSrvIP,
			"connectedstate",1,
	...
	//connectedprsinfo
	res = json_object_set(mcuinfo,"connectedprsinfo",
		json_pack("[{s:b,s:s},{s:b,s:s}]",
			"connectedstate",1,
			"connectedip",_gstrpShm->rc.nSrvIP,
			"connectedstate",1,
	...
	json_object_set(root,"mpcdinfo",mcuinfo);
	json_decref(mcuinfo);
